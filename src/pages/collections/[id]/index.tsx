    ...
    <>
      ...
      {data
        ? <>
          ...
          <P weight="bold">Issued by: {startAndEnd(ownerAddress, 5, 3)}<Copy text={ownerAddress} style={{marginLeft: '10px', verticalAlign: '-2px'}}/></P>
          <div className={styles.proxy_card}>
            <div className={styles.top}>
              <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                ...
                <P size="l" weight="bold" color="white" style={{display: 'flex', alignItems: 'center'}}>{data.token.collection.name}<Copy text={data.token.collection.address} style={{marginLeft: '10px', verticalAlign: '-2px'}}/></P>
              </div>
              <P size="sm" weight="bold" color="white" style={{display: 'flex', alignItems: 'center', height: '10%'}}>Soul: {startAndEnd(data.token.targetSoul.address, 4, 4)}<Copy text={data.token.targetSoul.address} style={{marginLeft: '10px', verticalAlign: '-2px'}}/></P>
            </div>
