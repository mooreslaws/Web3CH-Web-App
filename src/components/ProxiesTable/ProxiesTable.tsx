        ...
        >
          ...
          <tbody>
            {tokens.map((token: any, key: any) => (
              <tr key={key}>
                <td><Image loader={() => `https://avatars.dicebear.com/api/adventurer-neutral/${address}.svg`} src={`https://avatars.dicebear.com/api/adventurer-neutral/${address}.svg`} width={46} height={46}/>{token.metadata.agentNickname}</td>
