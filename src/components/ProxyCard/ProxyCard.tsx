    ...
    >
      <div className={styles.top}>
        <div className={styles.img}>
          <Image loader={() => `https://avatars.dicebear.com/api/adventurer-neutral/${address}.svg`} src={`https://avatars.dicebear.com/api/adventurer-neutral/${address}.svg`} objectFit="contain" layout="fill"/>
        </div>
